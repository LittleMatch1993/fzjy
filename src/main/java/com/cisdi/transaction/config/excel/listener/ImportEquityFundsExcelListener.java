...
public class ImportEquityFundsExcelListener extends AnalysisEventListener<EquityFundsDTO> {
    ...
    private List<String> columns= Arrays.asList(
            "干部姓名","身份证号","工作单位","现任职务","职务层次","标签","职级","人员类别","政治面貌","在职状态","家人姓名","称谓","投资的私募股权投资基金产品名称","编码","基金总实缴金额（人民币万元）","个人实缴金额（人民币万元）","基金投向","基金合同签署日","基金合同约定的到期日","私募股权投资基金管理人名称","登记编号","是否为该基金管理人的实际控制人","是否为该基金管理人的股东（合伙人）","认缴金额（人民币万元）","认缴比例（%）","认缴时间","是否担任该基金管理人高级职务","所担任的高级职务名称","担任高级职务的开始时间","担任高级职务的结束时间","基金管理人的经营范围","是否与报告人所在单位（系统）直接发生过经济关系","备注","填报类型","年度","有无此类情况"
    );
